...
Optimisation is at the heart of Machine Learning, indeed most practitioners
of ML rely on sophisticated methods to learn models from data. Optimisation
is also behind the scenes in reasoning, games, and many classical AI problems
such as optimal assignment.
...
|  | Entry                                                  | Description                                                 |
|--| --------                                               |------------------------------------------------------------ |
|01| [Tutorial 1 code](/files/Optimisation_for_AI/simplex_algorithm_student.ipynb) | Code for assignment 1, to be completed |
